                    ...
                    <div className="widget-content-outer">
                      <div className="widget-content-wrapper">
                        <div className="widget-content-left pr-2 fsize-1">
                          <div className="widget-numbers mt-0 fsize-3 text-night-sky">
                            0.14
                          </div>
                        </div>
                        <div className="widget-content-right w-100">
                          <div className="progress-bar-xs progress">
                            <div
                              className="progress-bar bg-night-sky"
                              role="progressbar"
                              aria-valuenow="71"
                              aria-valuemin="0"
                              aria-valuemax="100"
                      ...
                      <div className="widget-content-left fsize-1">
                        <div className="text-muted opacity-6 ">
                          <i className="header-icon lnr-earth icon-gradient bg-primary"></i>{" "}
                          Carbon Emission
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="widget-content">
                    <div className="widget-content-outer">
                      ...
                      <div className="widget-content-left fsize-1">
                        <div className="text-muted opacity-6">
                          {" "}
                          <i className="header-icon lnr-sun icon-gradient bg-warning">
                            {" "}
                          </i>
                          Current Temperature in A.A
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card-shadow-primary mb-3 widget-chart widget-chart2 text-left card">
                  <div className="widget-content">
                    <div className="widget-content-outer">
                      ...
                      <div className="widget-content-left fsize-1">
                        <div className="text-muted opacity-6">
                          <i className="header-icon lnr-cloud icon-gradient bg-happy-green">
                            {" "}
                          </i>
                ...
                <div className="card-shadow-primary mb-3 widget-chart widget-chart2 text-left card">
                  <div className="widget-content">
                    <div className="widget-content-outer">
                      ...
                      <div className="widget-content-left fsize-1">
                        <div className="text-muted opacity-6">
                          <i className="header-icon lnr-drop icon-gradient bg-happy-fisher">
                            {" "}
                          </i>
              ...
              <Col md="12" lg="12">
                <Card className="mb-3">
                  <CardHeader className="card-header-tab">
                    <div className="card-header-title">Rainfall Pattern</div>
                  </CardHeader>
